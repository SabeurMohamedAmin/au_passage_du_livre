...
const UPLOAD_DIR   = 'uploads/intervenants/photos'

const getBaseDir = () => join(process.cwd(), 'public', UPLOAD_DIR)

export async function saveIntervenantImage(file: MultiPartData): Promise<string> {
...
export async function deleteIntervenantImage(url: string): Promise<void> {
